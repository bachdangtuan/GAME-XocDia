...
export const XocDiaReducers = (state = initialState, action) => {
    switch (action.type) {
        ...
        case 'XOC_DIA': {
            ...
            //Render lại màn hình
            state.mangKetQua = mangXocDiaNgauNhien
            ...
            mangXocDiaNgauNhien.forEach((sp, index) => {
                ...
                if (indexXD !== -1) {
                    ...
                    console.log('state.mangChonVi[indexXD].diemCuoc', state.mangChonVi[indexXD].diemCuoc)
                    state.mangKetQua.tienThang = state.mangChonVi[indexXD].diemCuoc
                }
